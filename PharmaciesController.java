...
import com.io.codesystem.service.PharmacySearchService;
...
public class PharmaciesController {
	...
	public ResponseEntity<String> createPharmacyIndex() {
		...
		try {
			...
			response = "Failed to create ICD Index";
	...
	public ResponseEntity<Page<Pharmacies>> searchPharmacy(@RequestParam String searchTerm,@RequestParam(defaultValue = " ") String filter, Pageable pageable) {
