...
import com.io.codesystem.service.CptCodeSearchService;
...
public class CptCodeSearchController {
	...
	@PostMapping("/cpt/index")
	public ResponseEntity<String> createCptIndex() {
		...
		try {
			...
			response = "Failed to create CPT Index";
			e.printStackTrace();
	...
	public ResponseEntity<List<CptCodeCategory>> getCptCodeByCodeOrShortWithCtg(

			@RequestParam(value = "searchstring", required = false) String codeorshort) {

		HttpHeaders headers = new HttpHeaders();
		List<CptCodeCategory> cptCodeResponse = cptCodeSearchService.getCptCodeByCodeOrShortWithCtg(codeorshort);
